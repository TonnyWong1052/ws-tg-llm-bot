#!/bin/bash
# Activate conda base environment if available
echo "Activating conda base environment..."
source ~/miniconda3/bin/activate base 2>/dev/null || source ~/anaconda3/bin/activate base 2>/dev/null || conda activate base 2>/dev/null || echo "No conda environment found, continuing without it"
